 ...
 * @author vankhanh
 */
public class MonDayCoSinhVien extends javax.swing.JFrame {

    private int maMonSelected;
    DefaultTableModel tableModel = null;
    private MonDAO monHocDAO = null;

    public MonDayCoSinhVien() {
        initComponents();
    ...
    private void initData() {
        ...
        ResultSet monHocRS = monHocDAO.laySoLuongSVcuaTungMonDK(maGV);
        try {
            while (monHocRS.next()) {
                String tenMon = monHocRS.getString("tenMon");
                String soTin = monHocRS.getString("soTinChi");
                String soLuongSV = monHocRS.getString("soLuongSV");
                Object[] rowData = {tenMon, soTin, soLuongSV};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CÁC MÔN ĐANG DẠY HỌC");
        ...
        tblMonDay.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Môn học", "Số Tín", "Số Sinh viên theo học"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonDayCoSinhVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MonDayCoSinhVien().setVisible(true);
            }
        });
    }
